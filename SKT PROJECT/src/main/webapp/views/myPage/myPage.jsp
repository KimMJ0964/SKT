				...
				<ul class="interest-list">
							...
							<li>
								<div class="info">
									...
									<div class="text">
										...
										${interested.fsDate}<br> 지역 : ${interested.fsArea}
									</div>
								</div>
								<form action="interestedFestivalDelete.mp" method="POST"
									onsubmit="return confirm('정말 삭제하시겠습니까?');">
									<input type="hidden" name="fsNo" value="${interested.fsNo}">
									<button type="submit" style="background-color: #ff4242; border-style: none; color: white; border-radius: 50%;">x</button>
								</form>
							</li>
						</c:forEach>
					</c:if>
					...
					<c:if test="${not empty interestedListTwo}">
						<c:forEach var="interestedTwo" items="${interestedListTwo}">
							<li>
								<div class="info">
									<img src="festival.jpg" alt="투어 이미지">
									<div class="text">
								...
								<form action="interestedTourDelete.mp" method="POST"
									onsubmit="return confirm('정말 삭제하시겠습니까?');">
									<input type="hidden" name="tourNo" value="${interestedTwo.tourNo}">
									<button type="submit" style="background-color: #ff4242; border-style: none; color: white; border-radius: 50%;">x</button>
								</form>
							</li>
						</c:forEach>
					...
					<hr style="width: 90%;">
					<h6 style="font-weight: 800;">나만의 코스</h6>
					<c:if test="">
						<c:forEach var="interestedTwo" items="">
							<li>
